...
api.add_resource(ProjectRole, ProjectRole.url, ProjectRole.url+'/')
api.add_resource(ProjectTask, ProjectTask.url, ProjectTask.url+'/')
api.add_resource(ProjectVote, ProjectVote.url, ProjectVote.url+'/')
api.add_resource(VoteBallot, VoteBallot.url, VoteBallot.url+'/')
api.add_resource(Revision, Revision.url, Revision.url+'/')
api.add_resource(ProjectPhase, ProjectPhase.url, ProjectPhase.url+'/')
api.add_resource(ProjectComment, ProjectComment.url, ProjectComment.url+'/')
api.add_resource(ProjectReply, ProjectReply.url, ProjectReply.url+'/')
